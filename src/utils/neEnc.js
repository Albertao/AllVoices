...
// function neteaseEnc(id) {
// 	var magic = '3go8&$8*3*3h0k(2)2'.split('');
// 	var magicLen = magic.length;
// 	var song_id = id.split('');
// 	for(var i = 0; i < id.length; i++) {
// 		song_id[i] = song_id[i] ^ magic[i % magicLen];
// 	}
// 	md5 = md5(song_id.toString());
// 	res = encodeURI(md5).substr(0, md5.length-1);
// 	res.replace(/\\/g, '_');
// 	res.replace(/\+/g, '-')
// 	return res;
// }

// function createSecKey(size) {
// 	rand = 'shjishjiqu172568'
// 	var sec_key = ''
// 	for(var i = 0; i < rand.length; i++) {
// 		sec_key += rand.charAt(i).charCodeAt().toString(16);
// 	}
// 	return sec_key.substr(0, 16);
// }

// function aesEnc(text, sec_key) {
// 	pad = 16 - len(text) % 16;
// 	text = text + pad * String.fromCharCode(pad);
// 	aes = 
// }
...
export default function neEnc(d) {
    ...
    var h = {}
    i = '1q2w3e4r5t6y7u8i'
    h.params = b(c, '0CoJUm6Qyw8W8jud')
    h.params = encodeURIComponent(b(h.params, i))
    h.encSecKey = encodeURIComponent(_rsa_encrypt('1q2w3e4r5t6y7u8i', '010001', modulus))
    return h
}
